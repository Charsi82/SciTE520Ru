...
//!-start-[OnSendEditor]
const char* LuaExtension::OnSendEditor(Scintilla::Message msg, unsigned int wp, const char* lp) {
	return CallNamedFunction("OnSendEditor", (unsigned int)msg, wp, lp);
}
const char* LuaExtension::OnSendEditor(Scintilla::Message msg, unsigned int wp, long lp) {
	return CallNamedFunction("OnSendEditor", (unsigned int)msg, wp, lp);
}
//!-end-[OnSendEditor]
#endif //RB_OnSendEditor
