...
TWin::get_id()
//------------
{ return (int)GetWindowLongPtr(m_hwnd, GWL_ID); /*GetWindowLong(m_hwnd,GWL_ID);*/ }
...
//---------------------------------------
{
	...
	m_timer =(long)SetTimer(m_hwnd,1,msec,NULL);
 }
...
//EXPORT void get_app_path(wchar_t* _buff,int sz)
//{
// GetModuleFileName(NULL,_buff,sz);
//}
//
